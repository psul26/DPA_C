%
% This script performs a DPA attack with a simple DoM test.
%
...
for no_of_curves = min_no_of_curves:stepsize:max_no_of_curves
    ...
    for i = 1 : 8
        ...
        for k = 0 : 63
            ...
            meanB = mean(curves(setB,:));
            matrixDPA(k+1,:) = (meanA - meanB);
...
dlmwrite(fullfile(folder,'resultDPA4_dom.txt'),matrixResults4,'delimiter','\t','newline','pc');
