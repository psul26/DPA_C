...
function Trace = Func_RunPA(WaveDir, FileListName, TargetRange, ...
FileCount, TraceCount, SearchMode, ...
TargetSbox, FixedKeyFlag, FixedKey)
...
for i=1:1:FileCount
	...
	if(SearchMode(1,4)==1)
		temp_hc = Func_GenSF(cdata,SearchMode(1,1));
	...
	elseif(SearchMode(1,4)==0)
		temp_hm = Func_GenSF(mdata,SearchMode(1,1));
