...
class des_block:
	...
	def __init__(self, msg=None, nbits=0, format="hex"):
		"""
	...
	def pinv_tab(self, bit):
		"""Returns value of inverse permutation table P^(-1)[bit]"""
		return list( __P_PERM__ ).index( bit )
