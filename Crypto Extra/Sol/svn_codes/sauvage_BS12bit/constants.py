...
DIRECTORY = "../../secmatv1_2006_04_0809" # For traces from the filesystem on attack
...
#BEGIN_T, END_T = 5741, 5742 # Narrow Zoom for Turbo DPA (Test mode only)
...
# ------------------------------- 
# Constants specific to the atack
# ------------------------------- 
NBK = 1 # Number of best keys candidates to test
#NBK = 3 # Number of best keys candidates to test

REGL = False # Takes R0->L1 tranfert into account (L register)
#REGL = True 
...
#STABILITY_THRESHOLD = 2 # /!\ For test only
