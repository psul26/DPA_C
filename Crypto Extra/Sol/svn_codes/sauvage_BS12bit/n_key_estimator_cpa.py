# n_key_estimator_cpa.py provides some methods to evaluate the correctness
...
class n_key_estimator:
	...
	def __init__(self, sbox_key_list):
		...
		sbox_key_list is a list of [sbox,key]:
	...
	def __del__(self):
		...
		del self.__sbox_key_list #, self.__n, self.__h, self.__w, self.__hw, self.__h2, self.__w2, self.__diff
