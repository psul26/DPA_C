%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%--------------------------------------------------------------------------
% compute Intermediate values of round 16
%
...
function IV2 = computeIV2(model,sbox,ciphertext,keyHyp)
...
for i = 1 : 8
    for j = 0 : 7
        ciphertextBin(1,8*(i-1)+j+1) = bitand(1,bitshift(ciphertext(i),j-7));
    end;
end;
