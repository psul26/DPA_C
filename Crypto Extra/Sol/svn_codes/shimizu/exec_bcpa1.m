% bcpa batch file for random order
%
% by Hideo Shimizu
...
for trycount = 1:NumberOfTry
    ...
    FILELIST = db(ix,:);
    % exec bcpa
    countlog(trycount) = bcpa1(TRACEDIR, FILELIST, FLOG, VERBOSE, RATIO, SBOXORDER, FIRST, LAST, SIDE, SUBKEY, IterationThreshold, StabilityThreshold, IterationLimit);
