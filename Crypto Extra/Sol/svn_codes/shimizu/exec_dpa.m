% dpa batch file for random order
%
% by Hideo Shimizu
...
for trycount = 1:NumberOfTry
    ...
    FILELIST = db(ix,:);
    % exec dpa
    countlog(trycount) = dpa(TRACEDIR, FILELIST, FLOG, VERBOSE, RATIO, FIRST, LAST, SIDE, SUBKEY, IterationThreshold, StabilityThreshold, IterationLimit);
